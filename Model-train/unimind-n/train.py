...
def evaluate(args, model, tokenizer, eval_task=None, save_output=False):
    ...
    for task in tasks:
        ...
        if save_output:
            ...
            with open(os.path.join(args.output_dir, '{}_{}.decoded'.format(args.data_name, task)), 'w',encoding='utf-8') as outfile,\
                open(os.path.join(args.output_dir, '{}_{}.reference'.format(args.data_name, task)), 'w',encoding='utf-8') as reffile:
...
def main():
    ...
    parser.add_argument("--cache_dir", default='./projdata1/bert', type=str,
    ...
    parser.add_argument("--num_ft_epochs", default=1, type=float,
